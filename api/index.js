...
// Multer config - use /tmp on Vercel (serverless)
...
app.post('/api/upload', authenticateToken, requireAdmin, upload.single('image'), (req, res) => {
  ...
  // On Vercel, file uploads should use Supabase Storage instead
  // For now, return a temp path
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', time: new Date().toISOString(), database: 'supabase', runtime: 'vercel' })
})
